...
const UserViewLeft = ({ profileData }: any) => {
  // console.log(profileData?.lastName, 'profileData?.lastName')
  // ** States
      ...
      <Grid item xs={12}>
        <Card>
          <CardContent sx={{ pt: 13.5, display: 'flex', alignItems: 'center', flexDirection: 'column' }}>
            ...
            <CustomChip rounded skin='light' size='small' label={'Employee'} sx={{ textTransform: 'capitalize' }} />
          </CardContent>
            ...
            <Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
              <Box sx={{ pt: 4 }}>
                ...
                <Box sx={{ display: 'flex', mb: 3 }}>
                  ...
                  <Typography sx={{ color: 'text.secondary' }}>{profileData?.employeeEmail}</Typography>
                </Box>
                <Box sx={{ display: 'flex', mb: 3 }}>
                ...
                <Box sx={{ display: 'flex', mb: 3 }}>
                  ...
                  <Typography sx={{ color: 'text.secondary' }}>{profileData?.employeePhone}</Typography>
                </Box>
                <Box sx={{ display: 'flex', mb: 3 }}>
